...
const entries = [
  ...
  { key: "sparklingWine", icon: Zap },
  { key: "ecommerceHub", icon: Smartphone },
  { key: "vinificationAnalytics", icon: Brain },
  { key: "mechanization", icon: Globe },
  { key: "qrTraceability", icon: Shield },
