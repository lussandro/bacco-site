...
import { Wine, MapPin, Grape, Shield, FileCheck, Building2, Check, ArrowRight, Globe, Leaf, Mountain, DollarSign, Clock, FileText } from "lucide-react"
...
export default function ParaArgentina() {
  const t = useTranslations("argentina")

  const complianceItems = [
    { key: "senasa", icon: Shield },
    { key: "inv", icon: FileCheck },
    { key: "afip", icon: Building2 },
    { key: "factura", icon: FileCheck },
  ]

  const regionItems = ["mendoza", "sanJuan", "salta", "patagonia", "laRioja"]

  const grapeItems = ["malbec", "torrontes", "bonarda", "cabernetSauvignon", "syrah", "tempranillo", "chardonnay", "pinotNoir"]

  const integrationItems = ["afip", "mercadopago", "whatsapp", "rapt"]
      ...
      <main>
        ...
        <section className="py-20 lg:py-32 bg-gradient-to-br from-primary/10 via-primary/5 to-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <Badge className="mb-4 text-base px-4 py-1.5 bg-sky-600 text-white">
                {t("hero.badge")}
              </Badge>
        ...
        <section className="py-20 lg:py-32 bg-muted/30">
          <div className="container mx-auto px-4 lg:px-8">
                ...
                return (
                  <Card key={item.key} className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg">
                    <CardContent className="p-6">
                      <div className="h-14 w-14 rounded-xl bg-sky-600/10 flex items-center justify-center mb-4">
            ...
            <div className="mt-12 bg-gradient-to-r from-sky-600/10 via-sky-600/5 to-sky-600/10 rounded-2xl p-8 border border-sky-600/20">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-full bg-sky-600/20 flex items-center justify-center flex-shrink-0">
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg">
                <CardContent className="p-8 text-center">
                  <div className="h-20 w-20 rounded-full bg-sky-600/10 flex items-center justify-center mx-auto mb-6">
                    <span className="text-4xl font-bold text-sky-600">$</span>
                  </div>
                  <h3 className="text-2xl font-bold mb-4">{t("currency.peso.title")}</h3>
                  <p className="text-muted-foreground mb-6">{t("currency.peso.description")}</p>
                  <div className="flex flex-wrap justify-center gap-3">
                    <Badge variant="secondary">{t("currency.peso.features.multiCurrency")}</Badge>
                    <Badge variant="secondary">{t("currency.peso.features.autoConversion")}</Badge>
                    <Badge variant="secondary">{t("currency.peso.features.localPricing")}</Badge>
                  </div>
                </CardContent>
              </Card>
            </div>
        ...
        {/* CTA Section */}
        <section className="py-20 lg:py-32 bg-gradient-to-br from-sky-600/10 via-primary/5 to-background">
          <div className="container mx-auto px-4 lg:px-8">
