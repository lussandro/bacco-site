...
export default function ParaBrasil() {
  const t = useTranslations("brazil")
  ...
  const regionItems = ["serraGaucha", "valeSaoFrancisco", "planaltoCatarinense", "campanhGaucha", "serraDoSudeste", "camposDeCima"]
      ...
      <main>
        ...
        <section className="py-20 lg:py-32 bg-gradient-to-br from-primary/10 via-primary/5 to-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <Badge className="mb-4 text-base px-4 py-1.5 bg-green-600 text-white">
                {t("hero.badge")}
              </Badge>
        ...
        <section className="py-20 lg:py-32 bg-muted/30">
          <div className="container mx-auto px-4 lg:px-8">
                ...
                return (
                  <Card key={item.key} className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg">
                    <CardContent className="p-6">
                      <div className="h-14 w-14 rounded-xl bg-green-600/10 flex items-center justify-center mb-4">
            ...
            <div className="mt-12 bg-gradient-to-r from-green-600/10 via-green-600/5 to-green-600/10 rounded-2xl p-8 border border-green-600/20">
        ...
        {/* CTA Section */}
        <section className="py-20 lg:py-32 bg-gradient-to-br from-green-600/10 via-primary/5 to-background">
          <div className="container mx-auto px-4 lg:px-8">
