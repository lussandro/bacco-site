...
export default function ParaChile() {
  const t = useTranslations("chile")

  const complianceItems = [
    { key: "sag", icon: Database },
    { key: "do", icon: FileCheck },
    { key: "sii", icon: Building2 },
  ]

  const regionItems = ["valleCentral", "maipo", "colchagua", "casablanca", "maule"]

  const grapeItems = ["carmenere", "cabernetSauvignon", "sauvignonBlanc", "pais", "syrah", "chardonnay", "merlot", "pinotNoir"]

  const integrationItems = ["facturacion", "sii", "exportacion", "whatsapp"]
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero Section */}
        <section className="py-20 lg:py-32 bg-gradient-to-br from-red-600/10 via-red-600/5 to-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <Badge className="mb-4 text-base px-4 py-1.5 bg-red-600 text-white">
                {t("hero.badge")}
              </Badge>
        ...
        <section className="py-20 lg:py-32 bg-muted/30">
          <div className="container mx-auto px-4 lg:px-8">
                ...
                return (
                  <Card key={item.key} className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg">
                    <CardContent className="p-6">
                      <div className="h-14 w-14 rounded-xl bg-red-600/10 flex items-center justify-center mb-4">
            ...
            <div className="mt-12 bg-gradient-to-r from-red-600/10 via-red-600/5 to-red-600/10 rounded-2xl p-8 border border-red-600/20">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-full bg-red-600/20 flex items-center justify-center flex-shrink-0">
        ...
        {/* CTA Section */}
        <section className="py-20 lg:py-32 bg-gradient-to-br from-red-600/10 via-primary/5 to-background">
          <div className="container mx-auto px-4 lg:px-8">
